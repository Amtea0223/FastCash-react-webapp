...
import pic from "../images/loanService/sidepic/1.jpg"
...
const TU = ({ content,metaData }) => {
  window.scrollTo(0, 90)  
  return (
    <div className="loanServices">      
      <Helmet>
    <title>{metaData?.MT[2].metaTitle}</title>
    <meta name='description' content={metaData?.MT[2].metaDescription}/>
    <meta name='keywords' content={metaData?.MT[2].metaKeywords}/>
    </Helmet>
          ...
          <div className="loanServices-content-container">
            ...
            <div className="loanServices-content-desc">
              <div className="loanServices-content-title">
                {FormDatatext(content ? content[0].label : "")}
              </div>
              {FormDatatext(content ? content[0].description : "")}
            </div>
          </div>
        </div>
      </div>
