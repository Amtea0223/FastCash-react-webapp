...
import pic from "../images/loanService/sidepic/6.jpg"
...
const Creditcard = ({ content,metaData }) => {
  ...
  return (
   ...
   <Helmet>
    <title>{metaData?.MT[7].metaTitle}</title>
    <meta name='description' content={metaData?.MT[7].metaDescription}/>
    <meta name='keywords' content={metaData?.MT[7].metaKeywords}/>
    </Helmet>
          ...
          <div className="loanServices-content-container">
            ...
            <div className="loanServices-content-desc">
              <div className="loanServices-content-title">
                {FormDatatext(content ? content[5].label : "")}
              </div>
              {FormDatatext(content ? content[5].description : "")}
            </div>
          </div>
        </div>
      </div>
